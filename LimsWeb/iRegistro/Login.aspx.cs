...
namespace LimsWeb.iRegistro
{
    ...
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected string ing_email;
        protected string ing_pass;
        protected string refresh;
        protected string enter;
        protected string forgot;
        public static string user__not_exist;
        public static string data_incorrect;
        public static string user_inh;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    ing = "INGRESO";
                    ing_email = "Ingrese correo";
                    ing_pass = "Ingrese clave";
                    email.Text = "Correo";
                    pass.Text = "Clave";
                    lbnActualizarCaptcha.Text = "Actualizar Captcha";
                    btnIngresar.Text = "Ingresar";
                    forgot = "¿Olvidó su contraseña? Click aquí";
                    user__not_exist = "Usuario no existe";
                    data_incorrect = "Datos incorrectos";
                    user_inh = "La cuenta está deshabilitada. Por favor contacte a su administrador";
                ...
                {
                    ing = "LOGIN";
                    ing_email = "Enter email";
                    ing_pass = "Enter password";
                    email.Text = "Email";
                    pass.Text = "Password";
                    lbnActualizarCaptcha.Text = "Captcha Refresh";
                    btnIngresar.Text = "Enter";
                    forgot = "Forgot your password? Click here";
                    user__not_exist = "User doesn´t exist";
                    data_incorrect = "Incorrect data";
                    user_inh = "The account is disabled. Please contact your administrator";
        ...
        protected void btnIngresar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    string msj = "Error codigo captcha";
                    ScriptManager.RegisterStartupScript(this, typeof(Page), "MostrarMensaje", "alert('" + msj + "');", true);
                    crearCaptcha();
                }
