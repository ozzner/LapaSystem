<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Administrador.Master" AutoEventWireup="true" CodeBehind="repProducto.aspx.cs" Inherits="LimsWeb.iAdministrador.repProducto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphAdministrador" runat="server">
    ...
    <div style="padding: 20px; border-radius: 5px; font-size: 16px; background: #ddd; width: 94.2%; margin: 5px auto 0px 30px; height: 530px">
        ...
        <div>&nbsp;&nbsp;&nbsp;&nbsp;Seleccione Parametro &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Seleccione Estado</div>
        ...
        <a href="<%=enlace_6 %>" target="_blank"> <img src="<%= url_6 %>" style="height:201px; width:550px"/></a>
        </div>
        ...
        <asp:Button ID="btnGenerarReporte" OnClick="btnGenerarReporte_Click" ValidationGroup="ABC" runat="server" Text="GenerarReporte" style="margin-bottom:4px" CssClass="btn btn-primary" />
        ...
        <rsweb:ReportViewer ID="repvProducto" ShowExportControls="false"  runat="server"  ForeColor="Transparent"  Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="250px" Width="100%">
            <LocalReport ReportPath="iAdministradors\repProducto.rdlc">
            </LocalReport>
