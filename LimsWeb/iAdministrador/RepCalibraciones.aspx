<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Administrador.Master" AutoEventWireup="true" CodeBehind="RepCalibraciones.aspx.cs" Inherits="LimsWeb.iAdministrador.RepCalibraciones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphAdministrador" runat="server">
    ...
    <div style="padding: 20px; border-radius: 5px; font-size: 16px; background: #ddd; width: 95%; margin: 5px auto 0px auto; height: 530px">
      ...
      <asp:ScriptManager ID="smCalibraciones" runat="server"></asp:ScriptManager>
        <rsweb:ReportViewer ID="repvCalibraciones" runat="server"  ForeColor="Transparent" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="500px" Width="100%">
            <LocalReport ReportPath="iAdministradors\repCalibracion.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>
    </div>
