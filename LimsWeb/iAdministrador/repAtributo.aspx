<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Administrador.Master" AutoEventWireup="true" CodeBehind="repAtributo.aspx.cs" Inherits="LimsWeb.iAdministrador.repAtributo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphAdministrador" runat="server">
    ...
    <div style="padding: 20px; border-radius: 5px; font-size: 16px; background: #ddd; width: 94.2%; margin: 5px auto 0px 30px; height: 530px">
            <div>Seleccione Atributo </div> 
            <div style="height: 120px;width:160px; background: none; overflow-y: auto; display:inline-block;">
                <asp:RadioButtonList ID="cblAtributos" runat="server" Style="margin-left: 30px"></asp:RadioButtonList>
            </div>
        ...
        <a href="<%=enlace_5 %>" target="_blank"> <img src="<%= url_5 %>" style="height:201px; width:550px"/></a>
...
<%--          <asp:RadioButtonList ID="rbPendientes" runat="server" style="width:150px;background:none;display:inline-block;float:right;margin-right:80px">
            <asp:ListItem Value="1" Selected>Pendiente</asp:ListItem>
        ...
        <asp:Button ID="btnGenerarReporte" OnClick="btnGenerarReporte_Click" ValidationGroup="ABC"  runat="server" Text="GenerarReporte" CssClass="btn btn-primary" style="margin-bottom:4px" />
        ...
        <rsweb:ReportViewer ID="repvParametro" ShowExportControls="true" runat="server"  ForeColor="Transparent"  Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="250" Width="100%">
            <LocalReport ReportPath="iAdministradors\repAtributos.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>
