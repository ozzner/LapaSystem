<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="vMantenimiento.aspx.cs" Inherits="LimsWeb.iAdministrador.vMantenimiento" %>
...
<link href="../Content/css/bootstrap.css" rel="stylesheet" />
    <script>
        function EditarProducto(lnk) {
            ...
            $('#lblTitulo').text("Mantenimiento Finalizado");
...
<body style="background:#eee">
    <form id="form1" runat="server" style="margin:20px">
        <div class="etqs" style="font-weight:bold;font-size:large">
            <asp:Label runat ="server" text="MANTENIMIENTOS"></asp:Label>
        </div>
    ...
    <div style="background:none;display:inline-block;width:1000px;margin-top:10px ">
        ...
        <asp:DropDownList runat="server" class="txts" ID="ddlEquipo" style="width:347px"></asp:DropDownList>
        <br />
        
        <div class="etqs">
            <asp:Label runat ="server" text="Fecha Programada"></asp:Label>
        </div>
        <asp:TextBox runat="server" class="txts" TextMode="Date" Text="---" Height="27px" style="margin-top:4px;width:130px" ID="txtFecProgramada"></asp:TextBox>
        <asp:RequiredFieldValidator ID="rfvFecProg" ControlToValidate="txtFecProgramada" runat="server" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
     ...
     <div class="etqs" style="width:60px">
        ...
        <asp:RequiredFieldValidator ID="rfvOperador" ControlToValidate="txtOperador" runat="server" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>


          <asp:Button runat="server" text="Agregar Mantenimiento" CssClass="btns" ID="btnCrear" OnClick="btnCrear_Click" />
        ...
        <br />
            ...
            <div class="grilla" style="background:none;height:380px; overflow-y:auto">
                ...
                <asp:BoundField HeaderText=" _Id" DataField="MantenimientoID" HeaderStyle-CssClass="gvCabecera" Visible="false"
            ...
            <ItemTemplate>
                <asp:ImageButton ID="btnEditar" runat="server" Width="16px" ImageUrl="../Content/img/edit.png" 
                    CommandArgument='<%# Eval("MantenimientoID") %>'
            ...
            <ItemTemplate>
                <asp:ImageButton ID="btnEliminar" runat="server" Width="16px" ImageUrl="../Content/img/Eliminar.png"
                   OnCommand="btnEliminar_Command" CommandArgument='<%# Eval("MantenimientoID") %>' OnClientClick="javascript:return confirm('¿Confirma Eliminacion del registro?');"
                 ...
                 <div class="modal-body" style="color:black; ">
                     ...
                     <table style="margin:auto;">
                         <tr style="visibility:hidden">
                             ...
                             <td> <asp:TextBox ID="txtMantenimientoID" CssClass="popupTxts" runat="server" OnKeyPress="SoloLectura()" style="background:#d9d9d9; "></asp:TextBox>
