...
namespace LimsWeb.MasterPages
{
    public partial class Principal : System.Web.UI.MasterPage
    {
        ...
        protected string url_1;
        protected string enlace_1;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            welcome = etiquetas["WELCOME"];
            logout = etiquetas["LOGOUT"];

            user = etiquetas["USER"];
            product = etiquetas["PRODUCT"];
            param = etiquetas["PARAM"];
            atrib = etiquetas["ATRIB"];
            lab = etiquetas["LAB"];
            client = etiquetas["CLIENT"];
            plan = etiquetas["PLAN"];
           ...
           oEnt_Emp = oLN_Emp.ListarPubRaiz(ruc);
           string imagen = oEnt_Emp.imagen;
            
            
           if (imagen == null || imagen.Equals(""))
           {
               url_1 = "http://lapa-tec.com/backend/img_publicidad/default/img_1.jpg";
               enlace_1 = "http://wasitec.com";
           }
           else
           {
               url_1 = "http://localhost:1169/Content/img_publicidad/" + imagen;
               enlace_1 = oEnt_Emp.enlace;
           }
       ...
       public void Select_Change(Object sender, EventArgs e)
        {
            ...
            switch (Nivel) {
                ...
                case "LAB": Session["LaboratorioCod"] = tvEstructura.SelectedNode.Value;
                            ...
                            Response.Redirect("~/iAdministrador/AsociarProducto.aspx");
                    break;
                case "PRO": Session["ProdLabCod"] = tvEstructura.SelectedNode.Value;
                            ...
                            Response.Redirect("~/iAdministrador/Historial.aspx");
                    break;
                case "PAR": Session["ProdParaCod"] = tvEstructura.SelectedNode.Value;
                            ...
                            Response.Redirect("~/iAdministrador/EditarParametro.aspx");
                    break;
